...
export const Hero = () => {
  const whatsappLink =
    "https://wa.me/556796938634?text=Olá,%20vim%20do%20Site%20e%20gostaria%20de%20falar%20com%20um%20especialista.";
    ...
    >
      <div className="max-w-4xl mx-auto text-center space-y-8">
        <div className="flex justify-center mb-8">
          <img src={logo} alt="Fiorin Advocacia" className="w-[50rem] h-auto" />
        </div>
